...
class ATPensemble(object):
    ...
    def multiincepresnetprediction(self, seperatedfeature):
        ...
        multiincepresnetmodel = load_model('/home/songjiazhi/atpcapsule/paper/multiincepresnet-based predictor.hdf5')
    ...
    def multixceptionprediction(self, seperatedfeature):
        ...
        multixceptionmodel = load_model('/home/songjiazhi/atpcapsule/paper/multixception-based predictor.hdf5')
...
def main():
    ...
    templatesite = templatepredict.siteselection(blastoutdic, '/home/songjiazhi/atpcapsule/executive/sitedic.pickle')
